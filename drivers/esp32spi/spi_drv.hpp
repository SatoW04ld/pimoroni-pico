...
namespace pimoroni {
  ...
  public:
    ...
    int send_command(uint8_t command, const inParam *params_in, uint8_t num_in, uint8_t *data, uint16_t *data_len, cmd_response_type response_type=RESPONSE_TYPE_CMD);
    int send_command(uint8_t command, const inParam *params_in, uint8_t num_in);
    int send_command(uint8_t command, SpiDrv::tParam *params_out, SpiDrv::numParams num_out);
    int send_command(uint8_t command, uint8_t *data, uint16_t *data_len, bool dummy = true);
    int send_command(uint8_t command, bool dummy = true);
